...
<main id="content">
    ...
    <div class="max-w-5xl flex px-4 xl:px-0 py-24 mx-auto" id="single-loja">
        <!-- Grid -->
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center dark:text-white text-zinc-950">
            <div>
                ...
                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                    ...
                    <div class="py-5">
                        <div class="flex space-x-1">
                            <svg class="size-4 text-zinc-950 dark:text-neutral-200" width="51" height="51"
                        ...
                        <div class="mt-5">
                            <!-- Star -->
                            <svg class="h-auto w-16 text-zinc-950 dark:text-white" width="80" height="27"
                    ...
                    <div class="py-5">
                        ...
                        <div class="mt-5">
                            <!-- Star -->
                            <svg class="h-auto w-16 text-zinc-950 dark:text-white" width="110" height="28"
