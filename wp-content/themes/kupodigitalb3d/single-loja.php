...
<main id="content">
    ...
    <div class="max-w-5xl flex px-4 xl:px-0 pt-24 mx-auto" id="single-loja">
        <!-- Grid -->
                ...
                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                    ...
                    <div class="py-5">
                        ...
                        <p class="mt-3 text-sm text-zinc-950 dark:text-neutral-200">
                            <span class="font-bold"><?php echo ($store_rascore ? $store_rascore : 0); ?></span>/10 - Índice
                            RA
                        </p>

                        <div class="mt-3">
                            <!-- Star -->
                            <svg class="h-auto w-20 text-zinc-950 dark:text-white" viewBox="0 0 140 24" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#A4C929" id="path1" style="fill:#1a1a1a" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="none" id="path2" style="fill:#000000" />
                            </svg>
                            <!-- End Star -->
                        </div>
                    </div>
