...
<main id="content"> 
    ...
    <div class="max-w-5xl flex px-4 xl:px-0 py-24 mx-auto" id="single-loja">
        <!-- Grid -->
        <div class="grid grid-cols-2 w-full md:items-center dark:text-white text-zinc-950">

            <div class="w-3/4 min-w-full">
            ...
            <div class="w-full relative mx-5 ">
