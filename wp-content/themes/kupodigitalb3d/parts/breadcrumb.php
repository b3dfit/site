...
<nav class="relative max-w-[66rem] w-full mt-10 rounded-[10px] py-3 pl-5 pr-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto" aria-label="Breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
