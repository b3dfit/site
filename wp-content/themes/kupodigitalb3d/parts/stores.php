<div class="w-full relative overflow-hidden pt-4 dark:bg-zinc-950">
    <svg class="absolute -bottom-20 start-1/2 w-full transform -translate-x-1/2" height="488" viewBox="0 0 2745 488"
    ...
    <div class="relative z-10">
        <div class="max-w-5xl px-4 xl:px-0 mx-auto">
            <div class="mb-4">
                <h2 class="dark:text-neutral-400">Marcas e Lojas Confiáveis para Tênis de Performance.</h2>
            </div>

            <div class="flex justify-between gap-6 home-stores items-center">
                <?php
                $args = array(
                    'post_type' => 'loja',
                    'posts_per_page' => 8,
                ...
                if ($loja_query->have_posts()) :
                    while ($loja_query->have_posts()) :
                        ...
                        $svg = get_post_meta($post->ID, 'store_logosvg', true);
