...
<div class="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl text-center mx-auto mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Descubra as Novidades do Mundo da
            Performance</h2>
        <p class="mt-1 text-gray-600 dark:text-neutral-400">Mantenha-se atualizado com os artigos mais recentes da nossa
            comunidade. Explore dicas de treinamento, histórias de sucesso, recomendações de equipamentos, e muito mais
            para potencializar sua jornada de corrida.</p>
    </div>
    <!-- End Title -->
