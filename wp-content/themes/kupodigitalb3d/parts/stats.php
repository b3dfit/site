    ...
    <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        ...
        <div
            ...
            <div
                ...
                <div class="mb-5">
                    <svg class="flex-shrink-0 w-8 h-8   dark:fill-none"  viewBox="0 0 48 48"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill="none"  class="a  dark:stroke-white dark:fill-none  dark:stroke-2"
                        ...
                        <path fill="none" stroke="#000000" class="a dark:stroke-white dark:fill-none  dark:stroke-2"
            ...
            <div
                class="group relative z-10 p-4 md:p-6 h-full flex flex-col dark:bg-zinc-950 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-zinc-50/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100">
                <div class="mb-5">
                    <svg class="flex-shrink-0 w-8 h-8 " viewBox="0 0 48 48" 
                        xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <style>
                                .c {
                        ...
                        <path id="b" class="c dark:stroke-white dark:fill-none  dark:stroke-2"
                            d="m4.5,33.75c0-10.7696,8.7304-19.5,19.5-19.5s19.5,8.7304,19.5,19.5H4.5Z" />
                        <path class="c dark:stroke-white dark:fill-none dark:stroke-2"
               ...
               >
                <div class="mb-5">
                    <svg class="flex-shrink-0 w-8 h-8" viewBox="0 0 48 48"
                        ...
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M17.7283,31.5213h-8.43l-2.106,5.4438" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M7.1918,36.965v5.7794H18.3585" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M17.0417,31.5177l-.9506,5.4471v5.7794" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2"
                        ...
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M17.7283,31.5213l9.6087,0,2.1874,5.4438-8.8982,0m-4.5347,0H7.1924" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M29.5244,36.965v5.7794H18.3577" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M19.6746,31.5177l.716,4.1024.2346,1.3447v5.7794" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M10.7635,33.5992h1.6874" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M10.04,35.3832h1.6874" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M24.975,33.5992H23.2876" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M25.6988,35.3832H24.0113" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M15.0363,27.5678h-8.43L4.5,33.0116" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M4.5,33.0115v5.7793H7.1655" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M14.35,27.5651l-.6643,3.8063-.0217.1244" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2"
                        ...
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M15.0363,27.5678h9.6911l1.5293,3.9531M8.6015,33.0116H4.5" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M16.9836,27.5651l.683,3.9137" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M8.0717,29.6466H9.7591" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M22.2831,29.6466H20.5957" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2"
                        ...
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M35.0814,28.3088l0-6.1" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M43.5,37.4892c0,1.1436-1.8845,2.0708-4.2091,2.0708" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2"
                            d="M38.64,20.1376V6.8842a1.6286,1.6286,0,0,0-1.6286-1.6286H10.14A1.6286,1.6286,0,0,0,8.5114,6.8842V27.5134" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M14.7126,23.8075l4.87-7.8931,7.7335,4.6426L31.67,12.5205" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M43.5,31.3879c0,1.1436-1.8845,2.0707-4.2091,2.0707" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M43.5,34.4386c0,1.1436-1.8845,2.0707-4.2091,2.0707" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M39.2909,39.56c2.3246,0,4.2091-.9272,4.2091-2.0708V22.2083" />
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2"
                        ...
                        <path class="a dark:stroke-white dark:fill-none  dark:stroke-2" d="M43.5,28.31c0,1.1436-1.8845,2.0708-4.2091,2.0708" />
                        <line class="a dark:stroke-white dark:fill-none  dark:stroke-2" x1="39.2907" y1="39.5599" x2="39.2907" y2="30.3804" />
                        <line class="a dark:stroke-white dark:fill-none  dark:stroke-2" x1="28.8532" y1="35.2945" x2="30.8731" y2="35.2945" />
                    </svg>
