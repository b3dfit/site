...
<main id="content">
    <div class="max-w-5xl flex  px-4 xl:px-0 py-10 mx-auto" id="category">
        ...
        <div class="max-w-[85rem] px-4 py-2 sm:px-6 lg:px-8 mx-auto dark:text-white">
            ...
            <p class="mt-1 mb-3">Explore nossa extensa coleção de tênis de performance, cuidadosamente selecionados para atender corredores de todos os níveis. Utilize filtros de busca para encontrar o modelo ideal com base em marca, tipo de uso, características técnicas e avaliações da comunidade.</p>
        </div>
            <!-- End Title -->
