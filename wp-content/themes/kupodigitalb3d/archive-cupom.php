                ...
                $html = <<<HTML
                    ...
                    <div class="mt-2 p-0 rounded-lg border border-gray-200 bg-white text-black shadow-sm  disabled:opacity-50 disabled:pointer-events-none">
                            <div class="relative flex items-center overflow-hidden">
                                ...
                                <div
                                    class="md:w-64 h-full p-4 grow absolute flex items-center justify-center bg-lime-400  rounded-s-lg">
                                ...
                                <div class="md:w-1/2 grow p-4 ml-64">
                                    <div class="min-h-24 flex flex-col justify-center">

                                        <p class="text-neutral-700 mb-3 dark:text-neutral-300">
